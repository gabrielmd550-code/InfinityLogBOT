...
<div>
	<div style="float: left; width: 50%;">
		Category ID:<br>
		<input id="categoryID" class="round" type="text" style="width: 95%">
	</div>
	<div style="float: right; width: 50%;">
		Position:<br>
		<input id="position" class="round" type="text" style="width: 90%;">
	</div>
</div><br><br><br>
<div>
	...
	<div style="padding-left: 2%; float: left; width: 45%;">
		Channel Type:<br>
		<select id="info" class="round" onchange="glob.channeltype(this)">
...
<div id="text" style="display: none">
	...
	<div style="padding-left: 2%; float: left; width: 30%;">
		Clone NSFW:<br>
